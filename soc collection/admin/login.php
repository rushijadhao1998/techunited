...
<div class="text-center mb-3">
    <h4 class="logo-title">UNITED TECH CREDIT CO-OPERATIVE SOCIETY</h4>
    <div class="welcome">Welcome to Society Collection System</div>
</div>
...
<div class="form-floating mb-3">
    <input type="text" name="username" class="form-control"
           value="<?= $_COOKIE['admin_user'] ?? '' ?>" placeholder="Username" required>
...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="forgot-password.php" class="text-decoration-none small fg-pass">Forgot Password?</a>
</div>
